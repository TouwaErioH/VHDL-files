...
# lw sw
######################################################################################################################### instr.(H) ####### addr.(H)
      lui     $2, 0x1501          # high halfword the student no (last 8 digitals), use your own student no. instead!      # 0                0
      ori     $2, $2, 0x0028      # low halfword of the student no (last 8 digitals)                                       # 1                4
...
display:
      ...
      bne     $3, $0, dispstuno   #  if bit 8 = 0, display the original stu no. if bit 8 = 1, display the sorted stu no.   # 25               94
      nop
dispsortedstuno:
...
displayseg7label: 
      sw      $3,  0x04($0)       #  output to seg7                                                                        # 29               A4
      j       display                                                                                                      # 2A               A8
      nop
