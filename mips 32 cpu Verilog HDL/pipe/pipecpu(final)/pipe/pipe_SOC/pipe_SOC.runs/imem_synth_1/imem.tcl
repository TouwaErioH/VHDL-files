...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir D:/pipe/pipe_SOC/pipe_SOC.runs/imem_synth_1 -new_name imem -ip [get_ips imem]]
...
if { [catch {
  file copy -force D:/pipe/pipe_SOC/pipe_SOC.runs/imem_synth_1/imem.dcp d:/pipe/pipe_SOC/pipe_SOC.srcs/sources_1/ip/imem/imem.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub d:/pipe/pipe_SOC/pipe_SOC.srcs/sources_1/ip/imem/imem_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub d:/pipe/pipe_SOC/pipe_SOC.srcs/sources_1/ip/imem/imem_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim d:/pipe/pipe_SOC/pipe_SOC.srcs/sources_1/ip/imem/imem_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim d:/pipe/pipe_SOC/pipe_SOC.srcs/sources_1/ip/imem/imem_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/pipe/pipe_SOC/pipe_SOC.runs/imem_synth_1/imem_stub.v d:/pipe/pipe_SOC/pipe_SOC.srcs/sources_1/ip/imem/imem_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/pipe/pipe_SOC/pipe_SOC.runs/imem_synth_1/imem_stub.vhdl d:/pipe/pipe_SOC/pipe_SOC.srcs/sources_1/ip/imem/imem_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/pipe/pipe_SOC/pipe_SOC.runs/imem_synth_1/imem_sim_netlist.v d:/pipe/pipe_SOC/pipe_SOC.srcs/sources_1/ip/imem/imem_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/pipe/pipe_SOC/pipe_SOC.runs/imem_synth_1/imem_sim_netlist.vhdl d:/pipe/pipe_SOC/pipe_SOC.srcs/sources_1/ip/imem/imem_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/pipe/pipe_SOC/pipe_SOC.ip_user_files/ip/imem]} {
  catch { 
    file copy -force d:/pipe/pipe_SOC/pipe_SOC.srcs/sources_1/ip/imem/imem_stub.v D:/pipe/pipe_SOC/pipe_SOC.ip_user_files/ip/imem
  }
}

if {[file isdir D:/pipe/pipe_SOC/pipe_SOC.ip_user_files/ip/imem]} {
  catch { 
    file copy -force d:/pipe/pipe_SOC/pipe_SOC.srcs/sources_1/ip/imem/imem_stub.vhdl D:/pipe/pipe_SOC/pipe_SOC.ip_user_files/ip/imem
  }
}
